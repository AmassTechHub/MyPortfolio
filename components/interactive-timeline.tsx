...
export default function InteractiveTimeline() {
  ...
  const timelineEvents: TimelineEvent[] = [
    {
      year: "2025",
      title: "Vice President for Computer Science Society (CSS)- KNUST",
      description:
        "Currently leading student initiatives and fostering tech innovation at KNUST's premier computer science organization since August 2nd, 2025.",
