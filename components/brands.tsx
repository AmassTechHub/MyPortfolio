      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-16">
            ...
            >
              I lead two dynamic brands that blend technology and creativity. AmassTechHub focuses on software development, 
              project management, and tech education, while Amass Multimedia delivers professional photography, videography, 
              and content creation services. Both brands share a commitment to quality, innovation, and helping others succeed.
            </motion.p>
          </div>
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="flex justify-center">
                  <MagneticButton className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md">
                    <a href="#contact">Start a Tech Project</a>
                  </MagneticButton>
                </div>
              </div>
            </AnimatedCard>
